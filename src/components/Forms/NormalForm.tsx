    ...
    <div>
      <div>
        ...
        >
          ...
          <div>
           {double? <Button onClick={()=>setDouble((prev)=>!prev)} title="Single" className="btn-success mx-auto">
            
            </Button>: <Button onClick={()=>setDouble((prev)=>!prev)} title="Double" className="btn-success mx-auto">
